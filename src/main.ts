...
function layout(content: string, route: string) {
  app.innerHTML = `
    ...
    <footer><p>Color Signal Lens makes screenshot status signals easier to read.</p><p><a href="/privacy" data-nav>Privacy</a> · <a href="/terms" data-nav>Terms</a> · Built by Param Factory · v0.1.5</p></footer>`;
  wireNavigation();
  pageTitle(route);
}
