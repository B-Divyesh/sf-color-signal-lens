...
function renderLanding() {
  ...
  <section class="plus"><p class="eyebrow">LENS PLUS</p><h2>Save named presets for $12 once.</h2><p>The free app includes screenshot reading, labels, patterns, and blue-orange colors. Lens Plus saves named presets.</p><p>Sociobot/Dodo is the merchant of record. It processes the payment and handles refunds. A refund removes access to saved presets.</p><a class="button primary" href="https://api.sociobot.in/api/v1/products/color-signal-lens/checkout">Buy Lens Plus</a><button class="link-button" id="restore-license">Restore license</button><div id="license-area"></div></section>
