# Color Signal Lens handoff — repair v0.1.1
...
1. Desktop release workflow now waits for every platform build before creating
   ...
   repair is released as tag `v0.1.1`.
...
Pushing `main` deploys static `dist/site` through the configured static site
connection. Pushing `v0.1.1` runs `.github/workflows/release.yml`, which builds
