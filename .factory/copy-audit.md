...
| Privacy — Color Signal Lens | 5 | Pass; privacy title |
| Terms — Color Signal Lens | 5 | Pass; terms title |
...
| Open desktop downloads | 3 | Pass |
| Download the Windows installer. | 4 | Pass; `desktop-download-platforms` |
| Download for Windows | 3 | Pass; `desktop-download-platforms` |
| Download the Linux installer. | 4 | Pass; `desktop-download-platforms` |
| Download for Linux | 3 | Pass; `desktop-download-platforms` |
| Choose the macOS installer that matches your chip. | 8 | Pass; `desktop-download-platforms` |
...
| This license is no longer active. You can buy Lens Plus again. | 12 | Pass |
| License check is offline. The last active check is in use. | 11 | Pass |
| The license could not be checked. Connect to the internet and try again. | 13 | Pass |
...
| Copy | Words | Result |
| --- | ---: | --- |
| Demo — sample data, nothing is saved | 7 | Pass; `sample-lens` |
| Reset demo | 2 | Pass |
| Start for real | 3 | Pass |
| Sample checkout screenshot | 3 | Pass |
| See the sample status colors. | 5 | Pass |
| Active cue: Pattern for the removed status color. | 8 | Pass |
| Screenshot reader | 2 | Pass |
| Inspect a screenshot status color. | 5 | Pass |
| Click a status color in the image. Then choose how the overlay marks it. | 14 | Pass |
...
| Add a label, pattern, or blue-orange colors. | 7 | Pass |
| Load sample screenshot | 3 | Pass |
| Open screenshot | 2 | Pass |
| Capture screen region | 3 | Pass |
| No screenshot loaded. | 3 | Pass |
| Capture asks for screen permission only when you press it. | 10 | Pass |
| Select a region before it is added. | 7 | Pass |
| The screenshot stays on this device. | 6 | Pass |
| Keyboard: use the color field below, then press Apply selected color. | 11 | Pass |
| Overlay controls | 2 | Pass |
| Selected color | 2 | Pass |
| Apply selected color | 3 | Pass |
| Reading cue | 2 | Pass |
| Add a label | 3 | Pass |
| Add a pattern | 3 | Pass |
| Use blue-orange colors | 3 | Pass |
| Remap to | 2 | Pass |
| Blue | 1 | Pass |
| Orange | 1 | Pass |
| No reading cue | 3 | Pass |
| A text label marks the selected status color. | 8 | Pass |
| A pattern marks the selected status color. | 7 | Pass |
| The selected status color uses blue-orange colors. | 7 | Pass |
| The original screenshot is shown without an overlay. | 8 | Pass |
| Clear overlay | 2 | Pass |
| Lens Plus presets are unavailable in the demo. The reading controls stay free. | 13 | Pass |
| Saved presets | 2 | Pass |
| New preset name | 3 | Pass |
| Save preset | 2 | Pass |
| No presets saved yet. | 4 | Pass |
| Saved presets stay on this device. | 6 | Pass |
| Name the preset, then save it. | 6 | Pass |
| Enter a preset name, then rename it. | 7 | Pass |
| Could not open the screenshot. Choose a valid PNG, JPEG, or WebP image. | 13 | Pass |
| Screen capture did not start. Check screen-sharing permission, then try again or open a screenshot. | 15 | Pass |
| Select the screen region to inspect | 6 | Pass |
| Drag on the preview to select a region. You can also enter its pixel coordinates. | 15 | Pass |
| Choose a region before adding it. | 6 | Pass |
| Use selected region | 3 | Pass |
| Cancel | 1 | Pass |
...
| --- | ---: | --- |
| Privacy | 1 | Pass |
| Your screenshot stays on this device. | 6 | Pass |
| Color Signal Lens processes the screenshot you open in the app. | 11 | Pass |
| It does not upload screenshot data or use analytics. | 9 | Pass; `local-screenshots` |
| Local storage | 2 | Pass |
| The demo uses separate browser keys beginning with demo:. | 9 | Pass; `demo-isolation` |
| Reset demo deletes those keys. | 5 | Pass; `demo-reset` |
| A paid license is stored in your browser only when you add it. | 13 | Pass |
| Screen permission | 2 | Pass |
| The app asks for screen permission only after you press Capture screen region. | 13 | Pass; `capture-consent` |
| You choose the region before it is added. | 8 | Pass; `capture-consent` |
| You can use files or pasted screenshots instead. | 8 | Pass |
| Last updated: 29 August 2026. | 5 | Pass |
| Terms | 1 | Pass |
| Use the overlay to read your own screen. | 8 | Pass |
| Color Signal Lens helps you inspect screenshots that you choose. | 10 | Pass |
| Lens Plus | 2 | Pass |
| Lens Plus costs $12 as a one-time purchase through Sociobot's payment page. | 12 | Pass; `lens-plus-price` and `sociobot-checkout-path` |
| Sociobot/Dodo is the merchant of record. | 6 | Pass; `merchant-of-record` |
| It processes the payment and handles refunds. | 7 | Pass; `merchant-of-record` |
| A refund removes access to saved presets. | 7 | Pass; `refund-revocation` |
| Limits | 1 | Pass |
| You are responsible for the screenshots you open. | 8 | Pass |
| Not found | 2 | Pass |
| Page not found | 3 | Pass |
| Return to Color Signal Lens to open a screenshot. | 9 | Pass |
| Return home | 2 | Pass |
...
| Use Color Signal Lens | 4 | Pass |
| Open a screenshot, paste an image, or capture a screen region. | 11 | Pass; input claims |
...
| Lens Plus costs $12 as a one-time purchase and saves named presets on this device. | 15 | Pass; `lens-plus-price` and `named-presets` |
...
| selected state | status color |
| added treatment | overlay |
| text treatment | label |
| visual treatment | pattern |
| color treatment | blue-orange colors |
